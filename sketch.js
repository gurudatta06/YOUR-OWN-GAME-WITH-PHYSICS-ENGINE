...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   button2.position(480,110);
   button2.size(50,50);
   button2.mouseClicked(drop2);
 
   rope = new Rope(5,{x:300,y:225});
   rope2 = new Rope(9,{x:510,y:110});
  ...
  bunny = createSprite(170,100,100,100);
  bunny.scale = 0.2;
  ...
  base = createSprite(170,210,20,20);
  base.addImage("base",baes);
  base.scale=0.06
